...
In ADR [001-permissions-model-decisions.md](./001-permissions-model-decisions.md), we had initialy decided to go for one role per user for the whole app.  
...
This means that I am the owner of my workspaces, and I can also be a member or a guest of a workspace I was invited on.

## Rationale

To facilitate the cooperation of users between workspaces, scoping the role per workspaces is a requirement.
This will permit user to manage their own workspaces freely, and still be able to be invited to others' workspaces.
